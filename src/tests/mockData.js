...
export const stops1 = [
    ...
    {
    Text: "6th St and Cedar St",
    Value: "6CED"
    },
    {
    Text: "Selby Ave and Dale St",
    Value: "SLDA"
    },
    {
    Text: "Selby Ave and Hamline Ave",
    Value: "SLHA"
    },
    {
    Text: "Snelling Ave and University Ave",
    Value: "UNSN"
    },
    {
    Text: "Marshall Ave and Cleveland Ave",
    Value: "MARS"
    },
    {
    Text: "Summit Ave and Finn St",
    Value: "FINN"
    },
    {
    Text: "Lake St and 36th Ave",
    Value: "36LA"
    },
    {
    Text: "Transit Way and 27th Ave",
    Value: "TWAY"
    },
    {
    ...
    {
    Text: "Lake St and Cedar Ave",
    Value: "CELA"
    },
    {
    Text: "Chicago Lake Transit Center",
    Value: "CHLA"
    },
    {
    Text: "Lake St and Blaisdell Ave",
    Value: "BLLK"
    },
    {
    Text: "Uptown Transit Station",
    Value: "UPTS"
    }
    ]

export const departuresFINN = [
    {
    Actual: true,
    BlockNumber: 0,
    DepartureText: "Due",
    DepartureTime: "/Date(1647123848000-0600)/",
    Description: "UPTOWN",
    Gate: null,
    Route: "21",
    RouteDirection: "WB",
    ...
    BlockNumber: 0,
    DepartureText: "4:45",
    DepartureTime: "/Date(1647125100000-0600)/",
    Description: "UPTOWN",
    Gate: null,
    Route: "21",
    RouteDirection: "WB",
    ...
    BlockNumber: 0,
    DepartureText: "5:05",
    DepartureTime: "/Date(1647126300000-0600)/",
    Description: "UPTOWN",
    Gate: null,
    Route: "21",
    RouteDirection: "WB",
    ...
    BlockNumber: 0,
    DepartureText: "5:24",
    DepartureTime: "/Date(1647127440000-0600)/",
    Description: "UPTOWN",
    Gate: null,
    Route: "21",
    RouteDirection: "WB",
    ...
    BlockNumber: 0,
    DepartureText: "5:44",
    DepartureTime: "/Date(1647128640000-0600)/",
    Description: "UPTOWN",
    Gate: null,
    Route: "21",
    RouteDirection: "WB",
    ...
    BlockNumber: 0,
    DepartureText: "6:04",
    DepartureTime: "/Date(1647129840000-0600)/",
    Description: "UPTOWN",
    Gate: null,
    Route: "21",
    RouteDirection: "WB",
